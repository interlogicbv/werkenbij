...
export const dictionaries = {
  nl: {
    ...
    nav: {
      main: "Hoofdnavigatie",
      vacancies: "Vacatures",
      workingAt: "Werken bij",
      company: "Over Interlogic",
      homeLabel: "Interlogic – naar de homepage",
    ...
    hero: {
      ...
      titleStrong: "Uw logistieke partner",
      accentLead: "We think",
      accentStrong: "forward!",
      stats: ["Combinaties op de weg", "Beschikbaar vanuit Coevorden"],
      text: "Betrouwbaar, flexibel en persoonlijk transport door heel Europa. Wij denken mee, schakelen snel en zorgen dat uw zending aankomt.",
  ...
  en: {
    ...
    nav: {
      ...
      vacancies: "Vacancies",
      workingAt: "Working here",
      company: "About Interlogic",
      homeLabel: "Interlogic – go to homepage",
    ...
    hero: {
      ...
      titleStrong: "Your logistics partner",
      accentLead: "We think",
      accentStrong: "forward!",
      stats: ["Combinations on the road", "Available from Coevorden"],
      text: "Reliable, flexible and personal transport throughout Europe. We think with you, act quickly and make sure your shipment arrives.",
      cta: "Find your place",
    },
    intro: {
      eyebrow: "We think forward",
  ...
  de: {
    ...
    nav: {
      ...
      workingAt: "Arbeiten bei uns",
      company: "Über Interlogic",
      homeLabel: "Interlogic – zur Startseite",
      language: "Sprache wählen",
    },
    hero: {
      imageAlt: "Interlogic-Lkw unterwegs",
      eyebrow: "Transport & Logistik",
      titleLead: "Karriere bei Interlogic",
      titleStrong: "Ihr Logistikpartner",
      accentLead: "We think",
      accentStrong: "forward!",
      stats: ["Kombinationen auf der Straße", "Verfügbar ab Coevorden"],
      text: "Zuverlässige, flexible und persönliche Transporte in ganz Europa. Wir denken mit, handeln schnell und sorgen dafür, dass Ihre Sendung ankommt.",
    ...
    vacancy: {
      ...
      orCall: "Oder 0546-898960 anrufen",
