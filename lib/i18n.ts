...
export const dictionaries = {
  nl: {
    ...
    hero: {
      ...
      eyebrow: "Werken bij Interlogic",
      titleLead: "Klaar voor de",
      titleStrong: "rit?",
      accentLead: "Wij brengen je",
      accentStrong: "verder.",
  ...
  en: {
    ...
    hero: {
      ...
      eyebrow: "Careers at Interlogic",
      titleLead: "Ready for the",
      titleStrong: "journey?",
      accentLead: "We’ll take you",
      accentStrong: "further.",
      text: "A job where you are valued, trusted with responsibility and move things forward together every day.",
      cta: "Find your place",
    },
    intro: {
      eyebrow: "We think forward",
  ...
  de: {
    ...
    hero: {
      ...
      eyebrow: "Karriere bei Interlogic",
      titleLead: "Bereit für die",
      titleStrong: "Fahrt?",
      accentLead: "Wir bringen dich",
      accentStrong: "weiter.",
